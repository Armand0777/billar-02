                      ...
                      {misPedidos.map((pedido) => (
                        <div key={pedido.id_pedido} className="bg-[#1a1a1c] border border-white/10 p-4 rounded-2xl flex flex-col gap-3">
                          <div className="flex justify-between items-center pb-2 border-b border-white/5">
                            <span className="text-xs font-bold text-billanga-gray">Pedido a las {new Date(pedido.created_at).toLocaleTimeString("es-BO", { timeZone: "America/La_Paz", hour: '2-digit', minute:'2-digit', hour12: false})}</span>
